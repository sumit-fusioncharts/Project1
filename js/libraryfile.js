...
function Multivariant(chartdata) {
    ...
    this.chartHeight = this.svgHeight-60;
...
Multivariant.prototype.render = function(){
   ...
   var divisionX,divisiony,plotRatio,datasetStr="",ycord,xcord,y;
   ...
   for(datai in this.graphData){
      ...
      this.createText(url,svgGraph,(this.chartWidth)/2+this.marginxy,25,"small caption","#000",16,"middle","mainCaptionText");

      if(this.chartType=="line"){//line chart
         for(var i=0;i<dataArrayLen;i++){
            //Multivariant.xCoor[datai][i]=[];
            ...
            //Multivariant.xCoor[datai][i][0]=xcord;
            //Multivariant.xCoor[datai][i][1]=ycord;
            //Multivariant.xCoor[datai][i][2]=y;
            }
...
Multivariant.prototype.createCaption = function(url) {
   ...
   this.createText(url,svg,'50%',20,"big caption","#000",25,"middle","mainCaptionText");
   this.createText(url,svg,'50%',40,"small caption","#000",16,"middle","mainCaptionText");
};
...
Multivariant.prototype.createRect = function(url,svg,rectX,rectY,rectHeight,rectWidth,rectId,rectClass){
